...
/**
 * Searching for ComfyUI's models folder, which two very different surfaces now
 * depend on. The main-process half — which directories are even candidates —
 * is tested separately in comfyLocate.test.mjs.
 *
